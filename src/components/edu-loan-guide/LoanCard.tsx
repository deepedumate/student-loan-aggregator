...
export function LoanCard({
  ...
  // Only use key_features if it exists and has items
  if (
    loan.key_features &&
    ...
    >
      ...
      ${
        isInterested
          ...
          : "bg-white dark:bg-muted text-gray-900 dark:text-foreground border-2 border-gray-200 dark:border-border hover:bg-gray-50 dark:hover:bg-muted/80"
      }
    `}
          >
